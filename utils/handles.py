...
def handle_hit_bia_so_4(hit_info, original_frame, original_img, original_img_alt, mask):
    ...
    if transformed_point:
        ...
        cv2.drawMarker(processed_image, (int(transformed_point[0]), int(transformed_point[1])), (0, 0, 255), cv2.MARKER_CROSS, 15, 2)
        ...
        if transformed_point_alt:
            ...
            cv2.drawMarker(processed_image, (int(transformed_point_alt[0]), int(transformed_point_alt[1])), (0, 0, 255), cv2.MARKER_CROSS, 15, 2)
    ...
    if transformed_point is None:
        ...
        cv2.drawMarker(processed_image, transformed_point, (0, 0, 255), cv2.MARKER_CROSS, 15, 2)
...
def handle_miss(hit_info, original_frame):
    ...
    cv2.drawMarker(processed_image, shot_point, (0, 0, 255), cv2.MARKER_CROSS, 20, 2)

...
class ApplicationController(QMainWindow):
    def __init__(self):
        ...
        for widget in [self.main_menu, self.practice_screen, self.manage_screen, self.competition_menu, self.setup_competition_screen, self.competition_screen]:
    ...
    def _connect_signals(self):
        ...
        self.setup_competition_screen.ui.back_button.clicked.connect(self.show_competition_menu) # Sửa kết nối nút back

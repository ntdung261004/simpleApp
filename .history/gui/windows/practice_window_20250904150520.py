...
class PracticeWindow(QMainWindow):
    ...
    def setup_gui_connections(self):
        ...
        self.gui.soldier_selector.currentIndexChanged.connect(self._on_user_selected)
    ...
    def _on_soldier_selected(self, index):
        ...
        if soldier_data:
            if self.is_session_active:
                ...
                previous_index = self.gui.soldier_selector.findData(self.active_user)
                if previous_index != -1: self.gui.soldier_selector.setCurrentIndex(previous_index)
                return
            self.active_user = soldier_data

...
class PracticeWindow(QMainWindow):
    ...
    # --- THAY ĐỔI: Tích hợp đúng tên các nút từ ui_practice.py ---
    def setup_gui_connections(self):
        self.gui.zoomInButton.clicked.connect(self.zoom_in)
        self.gui.zoomOutButton.clicked.connect(self.zoom_out)
        self.gui.calibrateButton.clicked.connect(self.calibrate_center)
        self.gui.userButton.clicked.connect(self.show_user_dialog)
        self.gui.statsButton.clicked.connect(self.show_statistics_window)
        self.video_timer.timeout.connect(self.update_frame)
    # -------------------------------------------------------------

    def setup_worker_connections(self):
        self.request_processing.connect(self.worker.process_photo)
    ...
    def update_frame(self):
        if self.cam:
            ...
            if ret:
                # Thay thế hàm cũ bằng hàm mới từ ui_practice.py
    ...
    def handle_processing_done(self, result):
        ...
        # Cập nhật kết quả bằng hàm mới từ ui_practice.py

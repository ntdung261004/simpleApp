...
class VideoLabel(QLabel):
    ...
    def __init__(self, parent=None):
        ...
        # 2. Scale font và border-radius cho VideoLabel
...
class ManageGui(QWidget):
    def __init__(self): 
        ...
        # 3. Sử dụng f-string và scaler để tạo stylesheet động cho toàn bộ cửa sổ
        self.setStyleSheet(f"""
            ...
            QPushButton {{ background-color: #1abc9c; color: white; font-size: {scaler.scale(14)}px; font-weight: bold; border: none; padding: {scaler.scale(8)}px {scaler.scale(18)}px; border-radius: {scaler.scale(8)}px; }}
    ...
    def setupUi(self):
        # 4. Sử dụng scaler để tính toán lề và khoảng cách
        ...
        # 5. Sử dụng scaler.font() để tạo font động cho tiêu đề
    ...
    def _create_styled_panel(self) -> QFrame:
        ...
        # 6. Scale các giá trị của hiệu ứng đổ bóng
        shadow.setBlurRadius(scaler.scale(15))
        shadow.setColor(QColor(0, 0, 0, 80))
        shadow.setOffset(0, scaler.scale(4))
    ...
    def _create_center_column(self) -> QWidget:
        ...
        self.center_message_label.setStyleSheet(f"font-size: {scaler.scale(16)}px; color: #95a5a6;")
    ...
    def _create_analysis_box(self) -> QGroupBox:
        ...
        for row, name in enumerate(target_names):
            ...
            name_item.setFont(scaler.font(10, bold=True))
            ...
            # 8. Scale font và padding cho nút "Xem"
            view_button.setStyleSheet(f"padding: {scaler.scale(4)}px {scaler.scale(8)}px; font-size: {scaler.scale(9)}px;")
    ...
    def _create_shot_preview_box(self) -> QGroupBox:
        ...
        # 9. Scale font cho label chỉ số phát bắn
        self.shot_index_label.setStyleSheet(f"font-size: {scaler.scale(14)}px; font-weight: bold;")
    ...
    def _create_right_column(self) -> QWidget:
        ...
        data_widget = QWidget()
        data_layout = QVBoxLayout(data_widget)
        data_layout.setContentsMargins(margin, margin, margin, margin)
        data_layout.setSpacing(margin)
        ...
        self.right_message_label.setStyleSheet(f"font-size: {scaler.scale(16)}px; color: #95a5a6;")

...
class VideoLabel(QLabel):
    ...
    def paintEvent(self, event):
        ...
        if not self._pixmap.isNull():
            ...
            # Giữ lại văn bản "Chưa có ảnh" nếu không có pixmap
...
class ManageGui(QWidget):
    ...
    def setupUi(self):
        # --- BẮT ĐẦU VÙNG TINH CHỈNH: ÁP DỤNG FONT ĐỘNG ---
    ...
    def _create_analysis_box(self) -> QGroupBox:
        ...
        # Dynamically set table height to avoid scrollbar

...
class MainGui(QWidget):
    def __init__(self):
        ...
        # === BẮT ĐẦU SỬA LỖI: TINH CHỈNH STYLESHEET ===
        self.setStyleSheet("""
            ...
            /* Sửa lỗi: Loại bỏ nền cho các QLabel thông thường, bao gồm cả trong QGroupBox */
    ...
    def setupUi(self):
        ...
        root_layout.setContentsMargins(20, 10, 20, 20); root_layout.setSpacing(15)
    ...
    def _create_styled_panel(self) -> QFrame:
        ...
        shadow = QGraphicsDropShadowEffect(panel); shadow.setBlurRadius(20)
        shadow.setColor(QColor(0, 0, 0, 80)); shadow.setOffset(0, 5)
        panel.setGraphicsEffect(shadow); return panel

    def _create_camera_column(self) -> QWidget:
        panel = self._create_styled_panel()
        layout = QVBoxLayout(panel)
        layout.setContentsMargins(15, 15, 15, 15) # Giảm lề để các thành phần lớn hơn
        ...
        # === BẮT ĐẦU SỬA LỖI: Bọc các control trong một layout riêng để style không ảnh hưởng ===
        controls_container = QWidget()
        controls_layout = QHBoxLayout(controls_container)
        controls_layout.setContentsMargins(0, 5, 0, 0) # Giảm lề trên
        # === KẾT THÚC SỬA LỖI ===
        ...
        layout.addWidget(controls_container) # Thêm container vào layout chính
        return panel
    ...
    def _create_right_column(self) -> QWidget:
        ...
        session_layout.addWidget(self.soldier_selector); session_layout.addWidget(self.session_button)
        ...
        result_layout.addWidget(self.time_label); result_layout.addWidget(self.target_name_label)
        result_layout.addWidget(self.score_label); result_layout.addWidget(self.result_image_label, 1)
